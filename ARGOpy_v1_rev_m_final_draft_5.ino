...
//
        ...
        ////////////////////////////////////////
            ...
            // Motor Variables    
            double shutter_rotation_steps = 50;         // 200 steps  = 360* degrees
                                                        // 1 step     = 1.8* deg
...
//
        ...
        {   
            ...
            // Print the image header (@@ for testing so as to not interfere with the Python frontend)
            Serial.print(F("@@ "));
            ...
            for(int i = 1; i <= AMG88xx_PIXEL_ARRAY_SIZE; i++)
            {
                ...
                if( i%8 == 0 )
                {
                    Serial.println(F("")); // Print a newline
                    Serial.print(F("@@ ")); // Print another imager header for each 8 pixels in a row (@@ for testing so as to not interfere with the Python frontend)
                }
            }            
        ...
        float IR_Thermistor_Temperature()
        {
            ...
            // Print the IR temp header
            Serial.print(F("^^ "));
            
            // Print the IR Camera Sensor temp data for input to Python
            Serial.println(Tc);
        ...
        ///////////////////////////////
        float hash_IR_Image(float* image)
        {
...
//
        ...
        {   
            ...
            if ( (limitSwitchOpen == false) && (opticalSwitchLightLevel < opticalCalibrationLevel) )
                {
        ...
        {             
            ...
            if ( (limitSwitchClosed == false) && (opticalSwitchLightLevel >= opticalCalibrationLevel) )
            {   
